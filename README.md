...
● As part of PGDDSAI offered by IIIT & IBM, we built an end to end pipeline for Image detection and segmentation using the best industry practices.

● The segmentation model has been provided with an UI to run predictions and further was dockerized and deployed on cloud.
